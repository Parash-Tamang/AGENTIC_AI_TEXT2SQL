...
![TalkToDB chat interface](./docs/screenshots/chat-query.jpeg)
![Generated bar chart](./docs/screenshots/chat-chart.jpeg)
![Excel export](./docs/screenshots/excel-export.jpeg)
![](./docs/screenshots/excel-export(2).jpeg)
![](./docs/screenshots/excel-export(1).jpeg)
**Admin panel — Role & Access Management:**

![Role Management](./docs/screenshots/role-management.jpeg)
![Permission Set Creator — table selection](./docs/screenshots/permission-tables.jpeg)
![Permission Set Creator — row-level filters](./docs/screenshots/permission-filters.jpeg)
![Column Exclusions](./docs/screenshots/column-exclusions.jpeg)
